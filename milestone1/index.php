<html lang="en">
	...
	<body style="display: flex;">
		...
		-->
		<div style="background-color: yellow; width: 200px; text-align: center;">
			<h1 style="font-size: 20px;">AnaestheticsWiki</h1>
			<a href="index.php">Home</a>
		</div>

		<div style="padding: 40px;">
			<h1>Welcome to Anaesthetics Wiki</h1>
			<h2>The best place on the web to get information about Anaesthetics</h2>
		</div>
